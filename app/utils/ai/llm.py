...
def generate_answer_ollama(context: str, question: str) -> str:
    ...
    Правила:
    - Считай, что товар продаётся, если он присутствует в данных и его остаток на любом складе больше 0.
    - Если спрашивают стоимость или цену - отвечай основываясь на пункте цена.
